            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6 sm:gap-3">
                @if (config('crm.multi_institution') && auth()->user()->isSuperAdmin())
                    ...
                    <x-dropdown align="right" width="60">
                        <x-slot name="trigger">
                            <button class="inline-flex items-center px-3 py-2 border border-gray-200 text-sm leading-4 font-medium rounded-md text-gray-600 bg-white hover:text-gray-800">
                                {{ optional($__institutions->firstWhere('id', $__activeId))->name ?? __('Institucion') }}
